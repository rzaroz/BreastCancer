...
# Load the dataset
title = "4 model on BreastCancerWisconsin(Diagnostic) SMOTENC"
doc = Document()
doc.add_heading(title, level=1)

df_src = "SMOTENC-report/SMOTENC-BreastCancerWisconsin(Diagnostic).csv"
...
plt.title("RF confusion matrix - SMOTENC")
...
disp.plot(cmap=plt.cm.Blues)
plt.title("ADABoost confusion matrix - SMOTENC")
plt.xticks(rotation=40, fontsize=5)
plt.yticks(fontsize=5)
plt.show()
plt.clf()
...
disp.plot(cmap=plt.cm.Blues)
plt.title("XGBoost confusion matrix - SMOTENC")
plt.xticks(rotation=40, fontsize=5)
plt.yticks(fontsize=5)
plt.show()
plt.clf()
...
disp.plot(cmap=plt.cm.Blues)
plt.title("LGBM confusion matrix - SMOTENC")
plt.xticks(rotation=40, fontsize=5)
plt.yticks(fontsize=5)
plt.show()
plt.clf()
...
doc.save(f"SMOTENC-report/{title}.docx")
