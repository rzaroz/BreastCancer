...
# Load the dataset
title = "4 model on BreastCancerWisconsin(Diagnostic) BorderlineSMOTE"
doc = Document()
doc.add_heading(title, level=1)

df_src = "BorderlineSMOTE-report/BorderlineSMOTE-BreastCancerWisconsin(Diagnostic).csv"
...
plt.title("RF confusion matrix - BorderlineSMOTE")
...
disp.plot(cmap=plt.cm.Blues)
plt.title("ADABoost confusion matrix - BorderlineSMOTE")
plt.xticks(rotation=40, fontsize=5)
plt.yticks(fontsize=5)
plt.show()
plt.clf()
...
disp.plot(cmap=plt.cm.Blues)
plt.title("XGBoost confusion matrix - BorderlineSMOTE")
plt.xticks(rotation=40, fontsize=5)
plt.yticks(fontsize=5)
plt.show()
plt.clf()
...
disp.plot(cmap=plt.cm.Blues)
plt.title("LGBM confusion matrix - BorderlineSMOTE")
plt.xticks(rotation=40, fontsize=5)
plt.yticks(fontsize=5)
plt.show()
plt.clf()
...
doc.save(f"BorderlineSMOTE-report/{title}.docx")
