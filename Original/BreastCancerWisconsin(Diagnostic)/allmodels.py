...
# Load the dataset
title = "4 model on BreastCancerWisconsin(Diagnostic) Original"
doc = Document()
...
plt.title("RF confusion matrix - Original")
...
disp.plot(cmap=plt.cm.Blues)
plt.title("ADABoost confusion matrix - Original")
plt.xticks(rotation=40, fontsize=5)
plt.yticks(fontsize=5)
plt.show()
plt.clf()
...
disp.plot(cmap=plt.cm.Blues)
plt.title("LGBM confusion matrix - Original")
plt.xticks(rotation=40, fontsize=5)
plt.yticks(fontsize=5)
plt.show()
plt.clf()
