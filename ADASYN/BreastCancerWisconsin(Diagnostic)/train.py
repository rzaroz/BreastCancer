...
# Load the dataset
title = "4 model on BreastCancerWisconsin(Diagnostic) ADASYN"
doc = Document()
doc.add_heading(title, level=1)

df_src = "ADASYN-report/ADASYN-BreastCancerWisconsin(Diagnostic).csv"
...
plt.title("RF confusion matrix - ADASYN")
...
disp.plot(cmap=plt.cm.Blues)
plt.title("ADABoost confusion matrix - ADASYN")
plt.xticks(rotation=40, fontsize=5)
plt.yticks(fontsize=5)
plt.show()
plt.clf()
...
disp.plot(cmap=plt.cm.Blues)
plt.title("LGBM confusion matrix - ADASYN")
plt.xticks(rotation=40, fontsize=5)
plt.yticks(fontsize=5)
plt.show()
plt.clf()
...
doc.save(f"ADASYN-report/{title}.docx")
