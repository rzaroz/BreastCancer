...
# Load the dataset
title = "4 model on BreastCancerWisconsin(Diagnostic) CTGAN"
doc = Document()
doc.add_heading(title, level=1)

df_src = "CTGAN-report/CTGAN-BreastCancerWisconsin(Diagnostic).csv"
...
plt.title("RF confusion matrix - CTGAN")
...
disp.plot(cmap=plt.cm.Blues)
plt.title("ADABoost confusion matrix - CTGAN")
plt.xticks(rotation=40, fontsize=5)
plt.yticks(fontsize=5)
plt.show()
plt.clf()
...
disp.plot(cmap=plt.cm.Blues)
plt.title("XGBoost confusion matrix - CTGAN")
plt.xticks(rotation=40, fontsize=5)
plt.yticks(fontsize=5)
plt.show()
plt.clf()
...
disp.plot(cmap=plt.cm.Blues)
plt.title("LGBM confusion matrix - CTGAN")
plt.xticks(rotation=40, fontsize=5)
plt.yticks(fontsize=5)
plt.show()
plt.clf()
...
doc.save(f"CTGAN-report/{title}.docx")
